...
# Intentar varios indices de camara si CAMERA_INDEX falla
TRY_MULTIPLE_CAMERAS = True

# ============================================================
# CONFIGURACION GPIO OPCIONAL
# ============================================================
...
def setup_gpio():
    ...
    if not GPIO_AVAILABLE:
        print("GPIO no disponible. El programa seguira sin salida fisica.")
        return

    GPIO.setmode(GPIO.BCM)
    GPIO.setup(GPIO_PIN, GPIO.OUT)
    set_gpio_output(False)


def set_gpio_output(active):
    ...
    if GPIO_ACTIVE_HIGH:
        ...
        GPIO.output(GPIO_PIN, GPIO.LOW if active else GPIO.HIGH)
...
def open_camera():
    ...
    for index in camera_indexes:
        ...
        # Intentar formato MJPG, comun en webcams USB
        try:
...
def main():
    ...
    try:
        while True:
            ...
            cv2.imshow("Detector de Somnolencia - EAR", frame)
